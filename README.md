...
├── index.html          # Homepage
├── about.html          # Team mission and history
├── 77628D.html         # Team 77628D page
├── 77628P.html         # Team 77628P page
├── achievements.html   # Awards and competition history
├── contact.html        # Contact form and meeting schedule
├── resources.html      # Useful links for members
├── glossary.html       # Robotics terminology
└── standards.html      # Engineering and safety standards
```

## ✨ Key Features

- **Live Countdown**: Tracking the next VEX competition.
- **Search System**: Quick navigation across all pages (Ctrl+K).
- **Responsive Design**: Optimized for desktop and mobile viewing.
- **Safety Center**: Resources and a quiz managed by our Team Safety Captain.
- **Team Showcase**: Dedicated pages for our competitive sub-teams, 77628D and 77628P.
...
&copy; 2026 Mepham Robotics Club | Build. Code. Compete.
